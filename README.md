...
EduNova is an AI-powered academic dashboard that transforms your marks, attendance, and behaviour into clear, actionable insights. Powered by Google Gemini AI, it gives students a complete picture of their academic journey and tells them exactly what to do next.
...
- **Growth Tracking** — Identify where to push harder
...
edunova-ai/
├── public/
│   ├── coverpage.html     # Landing / cover page
